...
func Capitalizer(f1 *os.File, f2 *os.File) error {
	/*
		Open file 1, at offset 0,0, create an empty bufffer in which to dump the contents of file 1
		call strings.ToUpper on the buffer contents then copy to File 2 (converting the string to a NewReader)
	*/
...
func CapitalizerExample() error {
	...
	if _, err := f1.Write([]byte(`this file contains a number of words
